...
/**
 * Builds the frontend TypoScript setup array during OIDC authentication
 * (which runs before TypoScript is normally initialised in the middleware
 * chain). TYPO3 v14 removed TypoScriptFrontendController, so this variant
 * deliberately works without any TSFE object.
 */
class FrontendSimulationV14
{
    public function getTypoScriptSetup(ServerRequestInterface $originalRequest): array
    {
