...
return [
    ...
    'EXTENSIONS' => [
        ...
        'oidc' => [
            ...
            'oidcEndpointAuthorize' => 'http://oidc.t3ext-oidc.ddev.site/connect/authorize',
            'oidcEndpointLogout' => '',
            'oidcEndpointRevoke' => 'http://oidc.t3ext-oidc.ddev.site/connect/revocation',
            'oidcEndpointToken' => 'http://oidc.t3ext-oidc.ddev.site/connect/token',
            'oidcEndpointUserInfo' => 'http://oidc.t3ext-oidc.ddev.site/connect/userinfo',
            'oidcRedirectUri' => 'https://v13.t3ext-oidc.ddev.site/login/redirect',
